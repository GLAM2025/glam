...
def load_config(config_path):
    ...
    conf.Models.WorldModel.ShortNumLayers = 0
    ...
    conf.IncrementalImagine = CN()
    conf.IncrementalImagine.Flag = True
    conf.IncrementalImagine.InitialSteps = 8
    conf.IncrementalImagine.IncrementalSteps = 8
    conf.IncrementalImagine.IncrementFrequency = 30000
    conf.IncrementalImagine.MaxSteps = 16
